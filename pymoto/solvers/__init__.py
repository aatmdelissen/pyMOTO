...
from .iterative import Preconditioner, CG, BiCGSTAB, DampedJacobi, SOR, ILU, GeometricMultigrid
...
__all__ = ['matrix_is_sparse', 'matrix_is_complex', 'matrix_is_diagonal', 'matrix_is_symmetric', 'matrix_is_hermitian',
           ...
           'Preconditioner', 'CG', 'BiCGSTAB', 'DampedJacobi', 'SOR', 'ILU', 'GeometricMultigrid',
